...
public class GlobalExceptionHandler {
  ...
  public void createLog(LogLevel logLevel, String errorCode, String message, String requestPath) {
    ...
    if (logLevel == LogLevel.ERROR) {
      log.error("[EXCEPTION] path: {} | errorCode: {} | message: {}", requestPath, errorCode,
          message);
    } else {
      log.warn("[EXCEPTION] path: {} | errorCode: {} | message: {}", requestPath, errorCode,
          message);
    }
  }
  ...
  public ResponseEntity<GlobalExceptionResponse> handleGlobalHttpException(GlobalHttpException e,
    ...
    createLog(e.getLogLevel(), e.getClass().getSimpleName(), e.getMessage(),
  ...
  public ResponseEntity<GlobalExceptionResponse> handleException(Exception e,
    ...
    GlobalExceptionResponse response = new GlobalExceptionResponse(HttpStatus.INTERNAL_SERVER_ERROR,
        e.getClass().getSimpleName(), e.getMessage(), request.getRequestURI());
    createLog(LogLevel.ERROR, e.getClass().getSimpleName(), e.getMessage(),
        request.getRequestURI());
